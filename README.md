...
台灣本土語言文字轉音素 (Grapheme-to-Phoneme) 工具

Formosan Languages Grapheme-to-Phoneme Toolkit
...
- **異體字正規化**：自動將異體字轉換為標準字
- **中英混合支援**：可選擇性加入英文發音
- **擴展漢字支援**：完整支援臺客語常用的 CJK 擴展字集與私用區造字
...
| `U+20000-U+323AF` | CJK 擴展 B ~ H（臺客語常用外字） |
| `U+E000-U+F8FF` | 私用區 (PUA) |
| `U+F0000-U+10FFFD` | 私用區補充 A & B（臺客語造字） |
